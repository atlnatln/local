...
const LEVELS_BY_AGE = {
  ...
  '7-8': [
    ...
    { title: 'Labirent', desc: 'Duvarların arasından geç!', cols: 5, rows: 4, startX: 0, startY: 0, startVal: 7, targetX: 4, targetY: 3, targetVal: null, walls: [[1,0],[1,1],[3,2],[3,3],[3,1]], ops: [], commands: ['x+', 'x-', 'y+', 'y-'], maxCmds: 12, stars: [7, 10] },
  ...
  '9-10': [
    ...
    { title: 'Spiral', desc: 'Spiral yoldan geç!', cols: 5, rows: 5, startX: 0, startY: 0, startVal: 1, targetX: 2, targetY: 2, targetVal: null, walls: [[1,3],[1,2],[1,1],[2,1],[4,0],[3,0],[2,3],[4,2],[3,1],[1,0]], ops: [], commands: ['x+', 'x-', 'y+', 'y-'], maxCmds: 16, stars: [12, 14] },

...
```
Seviye 1: toplama + cikarma + carpma + bolme + siralama + eksik_sayi
...
- cikarma: 10 soru (5x zorluk 2 + 5x zorluk 3)
- carpma: 10 soru (5x zorluk 2 + 5x zorluk 3)
- bolme: 8 soru (5x zorluk 2 + 3x zorluk 3)
- siralama: 3 soru (3x zorluk 2)
- eksik_sayi: 3 soru (3x zorluk 2)
...
| 4 | a'nın 2/3'ü kaçtır? | 24'ün 2/3'ü kaçtır? → answer: 16 |
| 5 | a'nın 3/5'i kaçtır? | 30'un 3/5'i kaçtır? → answer: 18 |
...
| 3 | İki işlem | Ayşe'nin 30 bilyesi var. 8 tane verdi, 5 tane aldı. Kaç bilyesi var = ? |
| 4 | Bölme problemi | 48 çikolata 8 çocuğa eşit paylaştırıldı. Kaçar tane düştü = ? |
| 5 | Karışık | 3 kutu × 12 kalem + 15 kalem = toplam kaç kalem var = ? |
...
**Kesir:** "Sayıyı paydaya böl, payda ile çarp"
...
14. `type` geçerli: toplama, cikarma, carpma, bolme, siralama, eksik_sayi, **kesir, problem**
15. Kesir sonucu tam sayı
16. Problem metni Türkçe, günlük hayat

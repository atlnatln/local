#!/bin/bash
# ============================================================================
# MathLock Otomatik Tetikleyici — VPS Cron Tarafından Çalıştırılır
#
# Cron: */5 * * * * /home/akn/vps/projects/mathlock/mathlock-trigger.sh
#
# İşleyiş:
...
MATHLOCK_DIR="/home/akn/vps/projects/mathlock"
STATS_FILE="$MATHLOCK_DIR/data/stats.json"

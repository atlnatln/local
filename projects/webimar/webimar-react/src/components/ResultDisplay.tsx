          ...
          {mergedData.results && typeof mergedData.results === 'object' && (
            <>
              {Object.entries(mergedData.results).map(([key, value]) => {
                ...
                if (['kapasite', 'maksimum_kapasite', 'arazi_buyuklugu_m2', 'emsal_m2', 'maksimum_emsal', 'emsal_orani', 'arazi_alani', 'alan_m2', 'sonuc', 'maksimum_sera_alani', 'toplam_yapi_alani_m2', 'kalan_emsal_m2', 'uygulanan_kural', 'hesaplama_kurali_aciklama', 'yapilanabilir', 'arazi_alani_m2', 'silo_taban_alani_m2', 'maksimum_emsal_alani_m2', 'html_content', 'mevcut_alan_m2', 'gerekli_minimum_alan_m2', 'sorun_detay', 'neden', 'maksimum_insaat_alani_m2', 'kalan_emsal_hakki_m2', 'maksimum_yikama_alani_m2', 'maksimum_kurutma_alani_m2', 'fabrika_uretim_alani_m2', 'emsal_kullanim_orani', 'su_depolama_pompaj_alani_m2', 'emsal_tipi', 'detay_mesaj', 'alan_dagilimi', 'soguk_depo_kapasitesi_ton', 'bakici_evi_hakki', 'planlamai_kurulu_uyari', 'hayvan_tipi', 'uretim_tipi', 'kumes_alani_m2', 'mustemilat_alani_m2', 'gezinti_alani_kapasitesi', 'emsal_kapasitesi', 'belirleyici_kisit', 'maksimum_yapilasma_alani_m2', 'min_arazi_sarti_saglandi_mi', 'dut_bahcesi_var_mi', 'uyari_mesaji_ozel_durum', 'sonraki_adim_bilgisi', 'bakici_evi_m2', 'idari_bina_m2', 'uretim_alani_m2', 'depo_alani_m2', 'cekim_odasi_alani_m2', 'kutu_sayisi', 'beslenebilecek_kutu_sayisi', 'toplam_yaprak_ihtiyaci_kg', 'toplam_yas_koza_kg', 'emsal_orani_yuzde', 'maksimum_depo_alani', 'min_alan_sarti', 'zeytin_kontrol', 'depolama_kapasitesi_ton', 'kapali_su_havzasi_icinde', 'aciklama'].includes(key)) return null;

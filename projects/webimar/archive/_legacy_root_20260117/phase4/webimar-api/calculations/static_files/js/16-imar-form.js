...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadKmlLayers() {
        ...
        const kmlLayersToLoad = [
            { url: typeof KML_IZMIR_URL !== 'undefined' ? KML_IZMIR_URL : '/static/kml/izmir.kml', onLoad: handleIzmirKmlLoaded },
            { url: typeof KML_IZMIR_KAPALI_ALAN_URL !== 'undefined' ? KML_IZMIR_KAPALI_ALAN_URL : '/static/kml/izmir_kapali_alan.kml', onLoad: handleYasKapaliAlanLoaded },
            { url: typeof KML_BUYUK_OVALAR_IZMIR_URL !== 'undefined' ? KML_BUYUK_OVALAR_IZMIR_URL : '/static/kml/Büyük Ovalar İzmir.kml', onLoad: handleBuyukOvaLoaded }
        ];

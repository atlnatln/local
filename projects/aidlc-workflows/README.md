...
AI-DLC uses Kimi Code CLI's [Agent Skills](https://moonshotai.github.io/kimi-cli/en/customization/skills.md) and [Custom Agents](https://moonshotai.github.io/kimi-cli/en/customization/agents.md) to implement its intelligent workflow.

This repository includes a pre-configured `.kimi/` directory with:
- **Project development agents**: `master-orchestrator`, `inception-coder`, `construction-coder`, `operations-coder`
- **Repository maintenance agents**: `coder`, `explore`, `plan`, `rule-writer`, `evaluator`, `design-reviewer`, `security-auditor`
- **Project skills**: `pr-conventions`, `aidlc-rules`, `security-scans`, `markdown-style`, `scripts-guide`

**For AI-DLC Project Development (4-Agent Model):**

1. Ensure [Kimi Code CLI](https://moonshotai.github.io/kimi-cli/) is installed.
2. Copy `aidlc-rules/` and `.kimi/` to your new project:
   ```bash
   mkdir ~/projeler/my-app && cd ~/projeler/my-app
...
3. Start the Master Orchestrator:
   ...
   ```
4. Say: *"Using AI-DLC, start a new project."*
...
See [docs/KIMI_CLI_SETUP.md](docs/KIMI_CLI_SETUP.md) for detailed usage.
...
├── .kimi/
│   ├── AGENTS.md
│   ├── agent.yaml              # Repo maintenance agent
│   ├── agents/                 # AI-DLC 4-agent model
...
| Kimi Code CLI                 | [Install](https://moonshotai.github.io/kimi-cli/)                                                                                                               |

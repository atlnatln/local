...
- Updated: index (yeni konseptler listeye eklendi)
...
- Pages created: _archive/anka (Arşiv), anka (Yönlendirme) (arsivlendi)
...
## [2026-05-10 14:30] sub-page | meb-2024-curriculum + kimi-code-cli
- analysis/meb-2024-curriculum-technical-alignment.md: 525 → 306 satır
  - Çıkarılan: meb-2024-curriculum-render (render uyumu, ~102 satır)
  - Çıkarılan: meb-2024-curriculum-ontoloji (ontoloji/ID, ~123 satır)
- concepts/kimi-code-cli.md: 418 → 178 satır
  - Çıkarılan: kimi-code-cli-skills (skills sistemi, ~108 satır)
  - Çıkarılan: kimi-code-cli-agents (agent/sub-agent, ~127 satır)
- index.md güncellendi (4 yeni sayfa eklendi)

## [2026-05-10 14:45] lint | 7/10
- Orphan pages: 0
- Broken links: 2
- Missing from index: 0
- Frontmatter errors: 0
...
- Contradictions: 0
- Oversized pages: 6
- Unknown tags: 4 (data-model, ontology, render, skill)
- Raw existence: 0
- Log size: 94 entries

## [2026-05-10 14:46] lint | 9/10
- Orphan pages: 0
- Broken links: 0
- Missing from index: 0
- Frontmatter errors: 0
...
## [2026-05-10 15:01] lint | 7/10
- Orphan pages: 1 ([[analysis-index]])
- Broken links: 0
- Missing from index: 0
- Frontmatter errors: 0
- Stale pages: 0
- Contradictions: 0
- Oversized pages: 6
- Unknown tags: 1 (analysis)
- Raw existence: 0
- Log size: 97 entries

## [2026-05-10 15:03] lint | 9/10
- Orphan pages: 0
- Broken links: 0
- Missing from index: 0
- Frontmatter errors: 0
...
## [2026-05-10 14:48] index | analysis-index + cross-links
- Yeni: analysis/analysis-index.md (3 analiz sayfası, anahtar başlıklar tablosu)
- Güncel: index.md (açıklamalar zenginleştirildi, analysis-index linki)
- Güncel: concepts-index.md (kimi-code-cli-skills, kimi-code-cli-agents; analysis-index linki)
- Güncel: decisions-index.md (analysis-index cross-linki)
- Güncel: projects-index.md (analysis-index cross-linki)
- concepts-index.md'de meb sayfasının tipi `concept` → `analysis` düzeltildi
- Lint: 9/10 passed, 1 warning (page size), 0 failure

## [2026-05-10 15:05] lint | 9/10
- Orphan pages: 0
- Broken links: 0
- Missing from index: 0
- Frontmatter errors: 0
